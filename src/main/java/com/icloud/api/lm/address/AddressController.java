package com.icloud.api.lm.address;

import com.aliyun.oss.ServiceException;
import com.icloud.annotation.LoginUser;
import com.icloud.api.lm.address.service.AddressService;
...
//    @ApiOperation(value = "绑定烟时扫二维码获取信息", notes = "增加收货地址")
    ...
    @ResponseBody
    public ApiResponse addAddress(LmAddress address, @LoginUser LmUser user) throws ApiException {
    ...
    @ResponseBody
    public ApiResponse deleteAddress(Long addressId, Long userId,@LoginUser LmUser user) throws ApiException {
    ...
    @ResponseBody
    public ApiResponse updateAddress(LmAddress address, @LoginUser LmUser user) throws ApiException {
        Boolean result = addressService.addOrUpdateAddress(address);
        return new ApiResponse().okOrError(result);
    }
    ...
    @ResponseBody
    public ApiResponse getAllAddress(Long userId,@LoginUser LmUser user) throws ApiException {
    ...
    @ResponseBody
    public ApiResponse getDefAddress(Long userId,@LoginUser LmUser user) throws ApiException {
