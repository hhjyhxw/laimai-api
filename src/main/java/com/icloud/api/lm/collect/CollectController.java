package com.icloud.api.lm.collect;
...
public class CollectController {
    ...
    @ResponseBody
    public ApiResponse addCollect(@LoginUser LmUser user, Long spuId) throws ApiException {
        //校验SPU是否存在
    ...
    @ResponseBody
    public ApiResponse deleteCollect(@LoginUser LmUser user, Long spuId) throws ApiException{
    ...
    @ResponseBody
    public ApiResponse getCollectAll(@LoginUser LmUser user,Integer pageSize,Integer pageNo) throws ApiException{
    ...
    @ResponseBody
    public ApiResponse getCollectById(@LoginUser LmUser user, Long collectId, Long spuId ) throws ApiException{
    ...
    @ResponseBody
    public ApiResponse getCollectBySpuId(Long spuId, @LoginUser LmUser user) throws ApiException{
