package com.icloud.api.lm.footprint;
...
public class FootprintController {
    ...
    @ResponseBody
    public ApiResponse deleteFootprint(@LoginUser LmUser user, Long footprintId) throws ApiException {
    ...
    @ResponseBody
    public ApiResponse getAllFootprint(@LoginUser LmUser user) throws ApiException {
